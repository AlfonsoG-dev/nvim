...
`:CocInstall  coc-java@1.6.0 coc-pyright coc-json coc-tsserver coc-html coc-markdown-preview-enhanced coc-webview coc-htmldjango coc-lua coc-sql coc-git coc-css coc-vimlsp`
>>- `coc-java`: descarga la ultima versión y esta genera errores por lo tanto se instala la versión "1.6.0"
