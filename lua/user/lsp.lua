...
-- Error navigation
vim.keymap.set("n", "<space>k", vim.diagnostic.goto_next, opts)
vim.keymap.set("n", "<space>j", vim.diagnostic.goto_prev, opts)
vim.keymap.set("n", "<space>a", vim.diagnostic.setloclist, { desc = "Diagnostics to loclist" })
